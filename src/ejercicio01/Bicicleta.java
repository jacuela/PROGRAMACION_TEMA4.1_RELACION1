...
public class Bicicleta {
    ...
    public void cambiarPiñon(int piñon){
        ...
        //Vamos a controlar aquí que el piñon sea
        //del 1 al 5
        ...
        if (piñon>=1 && piñon<=5){
            ...
            //Piñon invalido
            System.out.println("ERROR: piñon "+piñon+" invalido");
        }
    ...
    public void mostrarVelocidad(){
        ...
        velocidad = this.piñonActual * this.revoluciones;
        
        System.out.println("Bici de "+this.propietario+":"+velocidad+ " km/h");
